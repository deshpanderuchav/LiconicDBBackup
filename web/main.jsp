...
<br/><br/>
<br/><br/><br/>
<a href="logout.jsp" style="float:right; margin-right:20px;"> Logout</a><br/><br/>
<hr>
...
<table style="float:left; margin-right:20px;">
    ...
    <form method="POST" action="dobackup">
        <tr><td colspan = "2" align ="center"> <input type="submit" value="  Backup  "></td></tr>
</table>
            </form>
       ...
       <table style="float:left; margin-right:20px;" >
           ...
           <tr>
               <th colspan="2">Schedule backup</th>
           </tr>
           <form action="email-time.jsp" method="post" >              
               <tr><td><input type="text" name="time"></td></tr>

               <tr><td><input type="submit" value="  Add  " name="addtime">   <input type="submit" value="  Delete  " name="deletetime"></td>
                    
                 </tr>
               <tr>
                   <td colspan="2">
                       <%
       String l[]= backup.getTime();
       for(int i=0;i<l.length && l[i]!=null; i++)
       {
        ...
        %>
           ...
           <table>
              ...
              <tr>
                 <td><input type="submit" value="  Add  " name="AddEmail">   <input type="submit" value="  Delete  " name="deleteEmail">
              </tr>
              <tr>
              </td><td colspan="2">
                    <%
       String em[]= backup.getEmail();
       for(int i=0;i<l.length && em[i]!=null; i++)
       {
